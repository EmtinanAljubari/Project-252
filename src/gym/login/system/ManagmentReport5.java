 ...
 * @author emtin
 */
public class ManagmentReport5 extends javax.swing.JFrame {

    /**
     * Creates new form ManagmentReport2
     */
    public ManagmentReport5() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagmentReport5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagmentReport5().setVisible(true);
            }
        });
    }
